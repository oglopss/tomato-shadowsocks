...
mbedtls_build()
{
    ...
    CC="mipsel-unknown-linux-uclibc-gcc -fPIC" CXX=mipsel-unknown-linux-uclibc-g++ AR=mipsel-unknown-linux-uclibc-ar RANLIB=mipsel-unknown-linux-uclibc-ranlib make SHARED=1 # CFLAGS=-fPIC

...
mbedtls_build()
{
    ...
    CC=mipsel-unknown-linux-uclibc-gcc CXX=mipsel-unknown-linux-uclibc-g++ AR=mipsel-unknown-linux-uclibc-ar RANLIB=mipsel-unknown-linux-uclibc-ranlib CFLAGS=-fPIC make SHARED=1  # > /dev/null 2>&1
